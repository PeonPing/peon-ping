...
| :--- | :--- | :---: |
| **README: path_rules config section** | Document path_rules array format, glob syntax, first-match-wins, override hierarchy | - [ ] Complete |
| **README: bind/unbind CLI reference** | Document `peon packs bind/unbind/bindings` commands | - [ ] Complete |
| **README: default_pack rename** | Update all references from `active_pack` to `default_pack` | - [ ] Complete |
| **README: session_override rename** | Update agentskill references to session_override | - [ ] Complete |
| **README: override hierarchy** | Document full 5-layer hierarchy table | - [ ] Complete |
| **README_zh.md** | Mirror all README changes in Chinese translation | - [ ] Complete |
| **docs/public/llms.txt** | Update config key references and add path_rules context | - [ ] Complete |
...
| :--- | :--- |
| **Documentation Gaps Identified?** | Pending |
| **Style Guide Updates Needed?** | Pending |
