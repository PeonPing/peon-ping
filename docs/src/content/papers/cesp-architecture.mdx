...
registry is just a `index.json` served via GitHub Pages at `nsxbet.github.io/registry/index.json`. each pack entry looks like:
...
- reference implementation: [github.com/NSXBet/peon-nsx](https://github.com/NSXBet/peon-nsx)
- registry: [nsxbet.github.io/registry](https://nsxbet.github.io/registry)
