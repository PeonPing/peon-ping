...
Debug logging:
  ...
  debug status           Show debug logging status and log directory

Log management:
  logs --last [N]        Show last N lines from latest log (default: 50)
  logs --session <id>    Show log entries for a specific session
